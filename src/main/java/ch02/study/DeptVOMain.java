...
// 또 타입은 무엇으로 해야 하나?
//클래스 구성요소 - 메서드와 필드(변수)
//VO(Value Object) 패턴 또는 DTO(Date Transfer Object)패턴
class DeptVO{//ERP시스템
    int deptno;// 부서번호 number(2) - int(4byte-32bit) or long(8byte-64bit)
    String dname;// 부서이름 varchar2 -> String
    String loc;// 자욕 varchar2 -> String
}
class DeptDTO{}
...
public class DeptVOMain {
    public static void main(String[] args) {
        ...
        //main메서드가 있는 클래스에서 다른 클래스에 선언된 변수를 접근하려면 인스터늣화 해야함.
        System.out.println(dvo.deptno);//10이 출력됨.
