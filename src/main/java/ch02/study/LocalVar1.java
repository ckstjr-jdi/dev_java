...
public class LocalVar1 {
    ...
    //automatic variable, local variable 자동으로 메모리에서 소멸됨.
    ...
    public static void main(String[] args) {
        //문제 지역변수 i의 값을 굳이 main메서드에서 출력하도록 코드를 작성하시오.
        LocalVar1 lv1 = new LocalVar1();
        //변수 i는 지역변수 이므로 아래와 같이 호출이 불가함.
        //System.out.println(lv1.i);
        lv1.methodB(3);
        //methodB는 리턴타입이 void이므로 대입연사자를 통해 반환받을 수 없음
        //int i = lv1.methodB(3);
        //methodA에서 선언된 지변 i와 main에서 선언된 지번 i는 서로 다르다.
        int i = lv1.methodA();
        System.out.println(i);
        lv1.methodB(3);
    }
